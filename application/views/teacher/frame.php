...
<frameset rows="87,*,32" id="_top_" name="_top_" frameborder="NO" border="0" framespacing="0">
    <frame src='<?=base_url();?>index.php/index/top3' name="topFrame"  scrolling="NO" noresize >
  <frameset cols="208,*" id="_middle_" name="_middle_">
		<frame src='<?=base_url();?>index.php/teacher/frame/menu' name="leftFrame" frameborder="0" border="0" scrolling="NO" noresize>
		<frame src='<?=base_url();?>index.php/teacher/frame/main' name="mainFrame">
  </frameset>
