            ...
            <div class="newrightboxtop1">
                <div class="practicenews">
                    <div class="practicenewsleft">
                        <span class="practice">实习</span><span class="newsfont">总结</span>
                    </div>
                    <div class="practicenewsright">
                        <p class="newsenglish">The practice of summary</p>
                    </div>
                </div>
            </div> 
                ...
                <?php if (is_array($news)) foreach ($news as $r): ?>
                    <li>
                        <tr>
                            ...
                            <td><a title="<?= $r['title'] ?>" href="<?= base_url() ?>index.php/admin/news/newsDetails4/<?= $r['newsId'] ?>" target="_blank">
                                    <b>.
                                        <?php
                                        if (strLength($r['title'], $charset = 'utf-8') > 24) {
                                            echo utf8Substr($r['title'], $from = 0, 24);
