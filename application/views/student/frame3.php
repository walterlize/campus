...
<frameset rows="87,*,32" id="_top_" name="_top_" frameborder="NO" border="0" framespacing="0">
  ...
  <frameset cols="208,*" id="_middle_" name="_middle_">
		<frame src='<?=base_url();?>index.php/student/frame/menu3' name="leftFrame" frameborder="0" border="0" scrolling="NO" noresize>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                ...
                                <tr>
                                    <td width="245" height="575" align="center" valign="top">
                                        <iframe name="content" scrolling="no" noresize src="<?= base_url(); ?>index.php/student/frame/menu3" height="100%" width="245" frameborder="0">                                
                                        </iframe>
                                    </td>
