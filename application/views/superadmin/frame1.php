                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td colspan="2" valign="top" height="150">
                                        <iframe name="Top" scrolling="no" noresize src="<?= base_url(); ?>index.php/index/top11" height="150" width="100%"
                                                frameborder="0"></iframe>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="245" height="575" align="center" valign="top">
                                        <iframe name="content" scrolling="no" noresize src="<?= base_url(); ?>index.php/superadmin/frame/menu1" height="100%" width="245" frameborder="0">                                
                                        </iframe>
                                    </td>
                                    <td width="849" valign="top" height="575">
                                        ...
                                        <iframe name="content1" noresize src="<?= base_url(); ?>index.php/superadmin/frame/main1" height="100%" width="100%" frameborder="0">                
                                        </iframe>
                                    </td>
                                </tr>
                                <tr>
