...
<frameset rows="87,*,32" id="_top_" name="_top_" frameborder="NO" border="0" framespacing="0">
    <frame src='<?=base_url();?>index.php/index/top4' name="topFrame"  scrolling="NO" noresize >
  <frameset cols="208,*" id="_middle_" name="_middle_">
		<frame src='<?=base_url();?>index.php/master/frame/menu' name="leftFrame" frameborder="0" border="0" scrolling="NO" noresize>
		<frame src='<?=base_url();?>index.php/master/frame/main' name="mainFrame">
  </frameset>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td colspan="2" valign="top" height="150">
                                        <iframe name="Top" scrolling="no" noresize src="<?= base_url(); ?>index.php/index/top4" height="150" width="100%"
                                                frameborder="0"></iframe>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="245" height="575" align="center" valign="top">
                                        <iframe name="content" scrolling="no" noresize src="<?= base_url(); ?>index.php/master/frame/menu" height="100%" width="245" frameborder="0">                                
                                        </iframe>
                                    </td>
                                    <td width="849" valign="top" height="575">
                                        ...
                                        <iframe name="content1"  noresize src="<?= base_url(); ?>index.php/master/frame/main" height="100%" width="100%" frameborder="0">                
                                        </iframe>
                                    </td>
                                </tr>
                                <tr>
